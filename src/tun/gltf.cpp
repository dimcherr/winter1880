...
List<ModelDesc> modelDescs {
    ...
    {"SlidingManholeLeft", [](Entity entity, Entity modelAsset) { prefab::SlidingManhole(entity, modelAsset, 0); }},
    {"SlidingManholeRight", [](Entity entity, Entity modelAsset) { prefab::SlidingManhole(entity, modelAsset, 1); }},
    ...
    {"GearSlotLeft", [](Entity entity, Entity modelAsset) { prefab::GearSlot(entity, modelAsset, 1.f, 0); }},
    {"GearSlotRight", [](Entity entity, Entity modelAsset) { prefab::GearSlot(entity, modelAsset, 1.f, 1); }},
    {"LeverStickMainLeft", [](Entity entity, Entity modelAsset) { prefab::LeverStick(entity, modelAsset, 0); }},
    {"LeverStickMainRight", [](Entity entity, Entity modelAsset) { prefab::LeverStick(entity, modelAsset, 1); }},
    {"LeverBaseMainLeft", [](Entity entity, Entity modelAsset) { prefab::LeverBase(entity, modelAsset, 0); }},
